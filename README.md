...
3. Распакуйте в удобную папку и запустите `LANShareManagerGUI.exe` (Windows автоматически запросит права Администратора через UAC).

### Вариант 2: Запуск через консоль (CLI)
